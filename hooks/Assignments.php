...
function Assignments_init(&$options, $memberInfo, &$args)
{
	...
	$options->FilterPage = 'hooks/Assignments_filter.php';
...
function Assignments_batch_actions(&$args)
{
		...
		*/
		...
		$command = [
			'l7f96jv6ah5nnuc8bqy0' => [
				'title' => "Teacher A",
				'function' => 'massUpdateCommand_l7f96jv6ah5nnuc8bqy0',
				'icon' => 'plus'
			],
			'sxhn8ezhhm2uhmsdv4v4' => [
				'title' => "Teacher B",
				'function' => 'massUpdateCommand_sxhn8ezhhm2uhmsdv4v4',
				'icon' => 'plus'
			],
			'zu9sk69g55s5es702kr5' => [
				'title' => "Lesson Type",
				'function' => 'massUpdateCommand_zu9sk69g55s5es702kr5',
				'icon' => 'cog'
			],
		];
		...
		switch($mi['group']) {
			case 'Admins':
				return array_merge(
					$custom_actions_top,
					[
						$command['l7f96jv6ah5nnuc8bqy0'],
						$command['sxhn8ezhhm2uhmsdv4v4'],
						$command['zu9sk69g55s5es702kr5']
					],
					$custom_actions_bottom
				);
		}
