...
<script>
	$j(function() {
		...
		Cal._fullCal = new FullCalendar.Calendar($j('#' + calId).get(0), {
			...
			eventSources: [{
				url: 'calendar-events-all-events.json.php',
				failure: function() {
...
<div id="all-calendar-loading" class="hidden alert alert-info text-center" style="width: 88%; height: 70vh; position: fixed; z-index: 500; top: 26vh;">
	<img src="<?php echo PREPEND_PATH; ?>loading.gif"> <span class="language" data-key="please_wait"></span>
</div>
<div id="all-calendar-events-loading-error" class="hidden alert alert-warning text-center">
