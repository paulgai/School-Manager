...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->QueryFieldsTV = [
		...
		"`Teachers`.`Name`" => "Name",
		"IF(    CHAR_LENGTH(`TeachersName1`.`Name`), CONCAT_WS('',   `TeachersName1`.`Name`), '') /* Name2 */" => "Name2",
	...
	$x->SortFields = [
		...
		3 => 3,
		4 => 4,
		5 => '`TeachersName1`.`Name`',
		6 => 6,
		7 => '`Teachers`.`Assumption_Date`',
		8 => '`Teachers`.`Mandatory_Hours`',
		9 => 9,
		10 => '`Teachers`.`Assigned_Hours_Theory`',
		11 => '`Teachers`.`Assigned_Hours_Lab`',
		12 => '`Teachers`.`Assigned_Hours`',
		13 => '`Teachers`.`Diff`',
	];
	...
	$x->filterers = ['SectorID' => '&#932;&#959;&#956;&#941;&#945;&#962;', 'Name2' => 'Name2', ];

	$x->QueryFrom = "`Teachers` LEFT JOIN `Sectors` as Sectors1 ON `Sectors1`.`id`=`Teachers`.`SectorID` LEFT JOIN `TeachersName` as TeachersName1 ON `TeachersName1`.`id`=`Teachers`.`Name2` ";
	$x->QueryWhere = '';
	$x->QueryOrder = '';
	...
	$x->ColCaption = ['&#932;&#959;&#956;&#941;&#945;&#962;', '&#917;&#954;&#960;&#945;&#953;&#948;&#949;&#965;&#964;&#953;&#954;&#972;&#962;', 'Name2', '&#932;&#959;&#960;&#959;&#952;&#941;&#964;&#951;&#963;&#951;', '&#913;&#957;&#940;&#955;&#951;&#968;&#951; &#933;&#960;&#951;&#961;&#949;&#963;&#943;&#945;&#962;', '&#933;&#960;&#959;&#967;&#961;&#949;&#969;&#964;&#953;&#954;&#941;&#962;', '&#920;&#949;&#969;&#961;&#943;&#949;&#962;', '&#917;&#961;&#947;&#945;&#963;&#964;&#942;&#961;&#953;&#945;', '&#931;&#973;&#957;&#959;&#955;&#959;', '&#916;&#953;&#945;&#966;&#959;&#961;&#940;', ];
	$x->ColFieldName = ['SectorID', 'Name_Sector', 'Name2', 'Placement', 'Assumption_Date', 'Mandatory_Hours', 'Assigned_Hours_Theory', 'Assigned_Hours_Lab', 'Assigned_Hours', 'Diff', ];
	$x->ColNumber  = [2, 3, 5, 6, 7, 8, 10, 11, 12, 13, ];
	...
	if(strpos($x->HTML, '<!-- tv data below -->')) {
		...
		if($row = db_fetch_row($res)) {
			...
			$sumRow .= '<td class="Teachers-Name2 sum"></td>';
