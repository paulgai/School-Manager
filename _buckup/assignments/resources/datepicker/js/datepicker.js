...
(function () {
  ...
  datePicker.languageinfo = navigator.language
    ? navigator.language
    : navigator.userLanguage;
  datePicker.languageinfo = datePicker.languageinfo
    ? datePicker.languageinfo.toLowerCase().replace(/-[a-z]+$/, "")
    : "en";

  // Load the appropriate language file
  var scriptFiles = document
    .getElementsByTagName("head")[0]
    .getElementsByTagName("script");
  var loc =
    scriptFiles[scriptFiles.length - 1].src.substr(
      0,
      scriptFiles[scriptFiles.length - 1].src.lastIndexOf("/")
    ) +
    "/lang/" +
    datePicker.languageinfo +
    ".js";
  ...
  function datePicker(options) {
    ...
    o.events = {
      ...
      onkeydown: function (e) {
        ...
        if (
          cacheDate.getFullYear() != o.date.getFullYear() ||
          cacheDate.getMonth() != o.date.getMonth()
        )
          o.updateTable();
        else {
          ...
          for (var i = start, td; (td = tds[i]); i++) {
            ...
            td.className =
              td.className.replace(/date-picker-hover/g, "") +
              " date-picker-hover";
          }
        }
        return o.killEvent(e);
      ...
      onmouseover: function (e) {
        ...
        this.className =
          this.className.replace(/date-picker-hover/g, "") +
          " date-picker-hover";
      ...
      onclick: function (e) {
        if (
          ...
          this.className.search(/out-of-range|day-disabled/) != -1
        )
          return false;
        if (e == null) e = document.parentWindow.event;
        var el = e.target != null ? e.target : e.srcElement;
    ...
    o.removeHighlight = function () {
      if (document.getElementById(o.id + "-date-picker-hover")) {
        document.getElementById(o.id + "-date-picker-hover").className =
          document
            .getElementById(o.id + "-date-picker-hover")
            .className.replace("date-picker-hover", "");
    ...
    o.getDisabledDates = function (y, m) {
      ...
      for (var i = o.disabledDates.length; i--; ) {
        ...
        if (
          tmp < Number(String(y) + m + "01") ||
          tmp > Number(y + String(m) + d)
        )
          continue;
        obj[tmp] = 1;
      }
      ...
      if (!o.staticPos) {
        ...
        var trueBody =
          document.compatMode && document.compatMode != "BackCompat"
            ...
            : document.body;
        var scrollTop =
          window.devicePixelRatio || window.opera ? 0 : trueBody.scrollTop;
        var scrollLeft =
          window.devicePixelRatio || window.opera ? 0 : trueBody.scrollLeft;

        if (
          parseInt(trueBody.clientWidth + scrollLeft) < parseInt(osw + pos[0])
        ) {
          o.div.style.left =
        ...
        if (
          parseInt(trueBody.clientHeight + scrollTop) <
    ...
    (o.createButton = function () {
      ...
      if (!document.getElementById("fd-but-" + o.id)) {
        ...
        but.title =
          typeof fdLocale == "object" &&
          options.locale &&
          fdLocale.titles.length > 5
            ? fdLocale.titles[5]
            : "";
      ...
      (o.create = function () {
        ...
        if (typeof fdLocale == "object" && o.locale) {
          ...
          if (fdLocale.firstDayOfWeek)
            o.firstDayOfWeek = o.defaults.firstDayOfWeek =
        ...
        createThAndButton(tr, [
          ...
          },
          {
            ...
            className: "today-but",
            id: "-today-but",
            text: datePicker.titles.length > 4 ? datePicker.titles[4] : "Today",
            onclick: o.events.gotoToday,
          },
          {
            className: "next-but",
            id: "-next-month-but",
            text: "\u203A",
            title: datePicker.titles[1],
            onmousedown: function (e) {
              o.events.incDec(e, 0, 0, 1);
            },
            onmouseout: o.events.clearTimer,
    ...
    o.setDateFromInput = function () {
      function m2c(val) {
        return String(val).length < 2
          ? "00".substring(0, 2 - String(val).length) + String(val)
          : val;
      }
      ...
      if (!o.splitDate) {
        var date = datePickerController.dateFormat(
          elem.value,
          o.format.search(/m-d-y/i) != -1
        );
      } else {
        var mmN = document.getElementById(o.id + "-mm");
        var ddN = document.getElementById(o.id + "-dd");
        var tm = parseInt(
          mmN.tagName.toLowerCase() == "input"
            ? mmN.value
            : mmN.options[mmN.selectedIndex].value,
          10
        );
        var td = parseInt(
          ddN.tagName.toLowerCase() == "input"
            ? ddN.value
            : ddN.options[ddN.selectedIndex].value,
          10
        );
        var ty = parseInt(
          elem.tagName.toLowerCase() == "input"
            ? elem.value
            : elem.options[elem.selectedIndex || 0].value,
          10
        );
        var date = datePickerController.dateFormat(
          tm + "/" + td + "/" + ty,
      ...
      if (!date) {
        ...
        date =
          ...
          m2c(new Date().getMonth() + 1) +
          m2c(new Date().getDate());
      }
    ...
    (o.setSelectIndex = function (elem, indx) {
      ...
      (o.returnFormattedDate = function () {
        ...
        var d =
          o.date.getDate() < 10 ? "0" + o.date.getDate() : o.date.getDate();
        var m =
          o.date.getMonth() + 1 < 10
            ? "0" + (o.date.getMonth() + 1)
            : o.date.getMonth() + 1;
        ...
        if (
          !(o.disableDays[weekDay] || String(yyyy) + m + d in disabledDates)
        ) {
          if (o.splitDate) {
            ...
            if (ddE.tagName.toLowerCase() == "input") {
              ...
              o.setSelectIndex(ddE, d); /*ddE.selectedIndex = d - 1;*/
            }

            if (mmE.tagName.toLowerCase() == "input") {
              mmE.value = m;
            } else {
              o.setSelectIndex(mmE, m); /*mmE.selectedIndex = m - 1;*/
            }
          ...
          if (!elem.type || (elem.type && elem.type != "hidden")) {
            elem.focus();
          }
          if (o.staticPos) {
    ...
    o.disableTodayButton = function () {
      var today = new Date();
      document.getElementById(o.id + "-today-but").className = document
        .getElementById(o.id + "-today-but")
        .className.replace("fd-disabled", "");
      if (
        o.outOfRange(today) ||
        (o.date.getDate() == today.getDate() &&
          o.date.getMonth() == today.getMonth() &&
          o.date.getFullYear() == today.getFullYear())
      ) {
        document.getElementById(o.id + "-today-but").className +=
          " fd-disabled";
        document.getElementById(o.id + "-today-but").onclick = null;
      } else {
        document.getElementById(o.id + "-today-but").onclick =
          o.events.gotoToday;
      }
    };
        ...
        if (y > 0) {
          ...
          but.appendChild(
            document.createTextNode(
              datePicker.dayAbbr
                ? datePicker.dayAbbr[d]
                : datePicker.fullDay[d].charAt(0)
            )
          );
    ...
    o.updateTable = function (noCallback) {
      if (o.timerSet) {
        ...
        d.setDate(
          Math.min(
            d.getDate() + o.dayInc,
            datePicker.getDaysPerMonth(
              d.getMonth() + o.monthInc,
              d.getFullYear() + o.yearInc
            )
          )
        );
      ...
      if (
        !noCallback &&
        "onupdate" in datePickerController &&
        typeof datePickerController.onupdate == "function"
      )
      ...
      var disabledDates = o.getDisabledDates(
        o.date.getFullYear(),
        o.date.getMonth() + 1
      );
      ...
      span[0].appendChild(
        document.createTextNode(datePicker.months[cm] + o.nbsp)
      );
      ...
      var stub =
        String(tdy) + (String(tdm + 1).length < 2 ? "0" + (tdm + 1) : tdm + 1);
        ...
        for (var col = 0; col < 7; col++) {
          ...
          if (i > firstColIndex && i <= firstColIndex + dpm) {
            ...
            if (o.outOfRange(tmpDate)) {
              ...
              if (
                o.dateSet != null &&
                o.dateSet.getDate() == dt &&
                o.dateSet.getMonth() == tdm &&
                o.dateSet.getFullYear() == tdy
              ) {
                cName.push("date-picker-selected-date");
              }

              if (
                o.disableDays[weekDay] ||
                stub + String(dt < 10 ? "0" + dt : dt) in disabledDates
              ) {
  ...
  datePickerController = (function () {
    ...
    var hideAll = function (exception) {
      ...
      for (dp in datePickers) {
        ...
        if (exception && exception == datePickers[dp].id) {
          continue;
        }
    ...
    var getDatePicker = function (inpId) {
      if (!(inpId in datePickers)) {
        throw (
          "No datePicker has been created for the form element with an id of '" +
          inpId.toString() +
          "'"
        );
      }
    ...
    var create = function (inp) {
      ...
      for (var i = 0, inp; (inp = inputs[i]); i++) {
        if (
          inp.className &&
          (inp.className.search(regExp6) != -1 ||
            inp.className.search(/split-date/) != -1) &&
          ((inp.tagName.toLowerCase() == "input" &&
            (inp.type == "text" || inp.type == "hidden")) ||
          ...
          if (inp.className.search(/split-date/) != -1) {
            if (
              document.getElementById(inp.id + "-dd") &&
              document.getElementById(inp.id + "-mm") &&
              document
                .getElementById(inp.id + "-dd")
                .tagName.search(/input|select/i) != -1 &&
              document
                .getElementById(inp.id + "-mm")
                .tagName.search(/input|select/i) != -1
            ) {
              options.splitDate = 1;
            }
          ...
          if (inp.className.search(regExp7) != -1) {
            ...
            options.divider =
              inp.className.search(regExp7) != -1 &&
              inp.className.match(regExp7)[0].replace("divider-", "") in
                dividers
                ? dividers[
                    inp.className.match(regExp7)[0].replace("divider-", "")
                  ]
                : "/";
          }
          ...
          if (inp.className.search(regExp3) != -1) {
            var tmp = inp.className
              .match(regExp3)[0]
              .replace(/highlight-days-/, "");
          ...
          if (inp.className.search(/range-low-today/i) != -1) {
            options.low = datePickerController.dateFormat(
              new Date().getMonth() +
                1 +
                "/" +
                new Date().getDate() +
            ...
            options.low = datePickerController.dateFormat(
              inp.className.match(regExp4)[0].replace(/range-low-/, ""),
              false
            );
            if (!options.low) {
              options.low = "";
          ...
          // The higher limit
          if (
            inp.className.search(/range-high-today/i) != -1 &&
            inp.className.search(/range-low-today/i) == -1
          ) {
            options.high = datePickerController.dateFormat(
              new Date().getMonth() +
                1 +
                "/" +
                new Date().getDate() +
            ...
            options.high = datePickerController.dateFormat(
              inp.className.match(regExp5)[0].replace(/range-high-/, ""),
              false
            );
            if (!options.high) {
              options.high = "";
