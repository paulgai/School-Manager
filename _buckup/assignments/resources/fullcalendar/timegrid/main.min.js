...
!(function (e, t) {
  ...
  var o = function () {
    ...
    s = (function (e) {
      function r(r) {
        ...
        return (
          (i.timeGrid = r),
          (i.fullTimeFormat = t.createFormatter({
            hour: "numeric",
            minute: "2-digit",
      ...
      return (
        ...
        (r.prototype.attachSegs = function (e, t) {
          for (
            var r = this.timeGrid.groupSegsByCol(e), i = 0;
            i < r.length;
            i++
          )
            r[i] = this.sortEventSegs(r[i]);
          (this.segsByCol = r),
        ...
        (r.prototype.computeSegSizes = function (e) {
          ...
          if ((t.computeSegVerticals(e), r))
            for (var n = 0; n < i; n++) this.computeSegHorizontals(r[n]);
        }),
        (r.prototype.assignSegSizes = function (e) {
          ...
          if ((t.assignSegVerticals(e), r))
            for (var n = 0; n < i; n++) this.assignSegCss(r[n]);
        }),
        ...
        (r.prototype.renderSegHtml = function (e, r) {
          var i,
            ...
            d = a.ui,
            c = l.allDay,
            h = s.computeEventDraggable(l, d),
            u = e.isStart && s.computeEventStartResizable(l, d),
            p = e.isEnd && s.computeEventEndResizable(l, d),
            f = this.getSegClasses(e, h, u || p, r),
            g = t.cssToStr(this.getSkinCss(d));
          if ((f.unshift("fc-time-grid-event"), t.isMultiDayRange(a.range))) {
            if (e.isStart || e.isEnd) {
              var m = e.start,
                y = e.end;
              (i = this._getTimeText(m, y, c)),
                (n = this._getTimeText(m, y, c, this.fullTimeFormat)),
                (o = this._getTimeText(m, y, c, null, !1));
            }
          } else
            (i = this.getTimeText(a)),
              (n = this.getTimeText(a, this.fullTimeFormat)),
              (o = this.getTimeText(a, null, !1));
          return (
            '<a class="' +
            f.join(" ") +
            '"' +
            (l.url ? ' href="' + t.htmlEscape(l.url) + '"' : "") +
            (g ? ' style="' + g + '"' : "") +
            ...
            (i
              ...
              : "") +
            (l.title
              ? '<div class="fc-title">' + t.htmlEscape(l.title) + "</div>"
              : "") +
            "</div>" +
        ...
        (r.prototype.computeSegHorizontals = function (e) {
          ...
          if (
            ((function (e) {
              ...
              for (t = 0; t < e.length; t++)
                for (r = e[t], i = 0; i < r.length; i++)
                  for (
                    (n = r[i]).forwardSegs = [], o = t + 1;
                    o < e.length;
                    o++
                  )
                    l(n, e[o], n.forwardSegs);
            })(
              (t = (function (e) {
                var t,
                  r,
            ...
            for (i = 0; i < r.length; i++)
              this.computeSegForwardBack(r[i], 0, 0);
          }
        }),
        (r.prototype.computeSegForwardBack = function (e, t, r) {
          ...
          if (void 0 === e.forwardCoord)
            for (
              n.length
                ? (this.sortForwardSegs(n),
                  this.computeSegForwardBack(n[0], t + 1, r),
                  (e.forwardCoord = n[0].backwardCoord))
                : (e.forwardCoord = 1),
                e.backwardCoord =
        ...
        (r.prototype.assignSegCss = function (e) {
          for (var r = 0, i = e; r < i.length; r++) {
            var n = i[r];
            t.applyStyle(n.el, this.generateSegCss(n)),
  ...
  function a(e) {
    ...
    if (void 0 === e.forwardPressure) {
      for (t = 0; t < i.length; t++)
        a((r = i[t])), (n = Math.max(n, 1 + r.forwardPressure));
      e.forwardPressure = n;
    }
  }
  function l(e, t, r) {
    ...
    for (var i = 0; i < t.length; i++)
      (n = e), (o = t[i]), n.bottom > o.top && n.top < o.bottom && r.push(t[i]);
    var n, o;
    return r;
  }
  function d(e) {
    ...
    return (
      (r.forwardPressure = e.forwardPressure),
      (r.backwardCoord = e.backwardCoord),
      r
    );
  }
  var c = (function (e) {
      ...
      return (
        ...
        (t.prototype.generateSegCss = function (t) {
          ...
          if (i && i.col === t.col) {
            ...
            (r.left = n.left),
              (r.right = n.right),
              (r.marginLeft = n.marginLeft),
              (r.marginRight = n.marginRight);
          }
          return r;
        }),
        t
        ...
        (t.prototype.attachSegs = function (e, t) {
          ...
          return (
            "bgEvent" === e
              ? (r = i.bgContainerEls)
              : "businessHours" === e
              ? (r = i.businessContainerEls)
              : "highlight" === e && (r = i.highlightContainerEls),
    ...
    p = (function (e) {
      function i(r, i, n) {
        ...
        (o.isSlatSizesDirty = !1),
          (o.isColSizesDirty = !1),
          (o.renderSlats = t.memoizeRendering(o._renderSlats));
        var a = (o.eventRenderer = new s(o)),
          l = (o.fillRenderer = new h(o));
        o.mirrorRenderer = new c(o);
        var d = (o.renderColumns = t.memoizeRendering(
          o._renderColumns,
          o._unrenderColumns
        ));
        return (
          (o.renderBusinessHours = t.memoizeRendering(
            l.renderSegs.bind(l, "businessHours"),
            l.unrender.bind(l, "businessHours"),
            [d]
          )),
          (o.renderDateSelection = t.memoizeRendering(
            o._renderDateSelection,
            o._unrenderDateSelection,
            [d]
          )),
          (o.renderFgEvents = t.memoizeRendering(
            a.renderSegs.bind(a),
            a.unrender.bind(a),
            [d]
          )),
          (o.renderBgEvents = t.memoizeRendering(
            l.renderSegs.bind(l, "bgEvent"),
            l.unrender.bind(l, "bgEvent"),
            [d]
          )),
          (o.renderEventSelection = t.memoizeRendering(
            a.selectByInstanceId.bind(a),
            a.unselectByInstanceId.bind(a),
            [o.renderFgEvents]
          )),
          (o.renderEventDrag = t.memoizeRendering(
            o._renderEventDrag,
            o._unrenderEventDrag,
            [d]
          )),
          (o.renderEventResize = t.memoizeRendering(
          ...
          (i.innerHTML =
            ...
            o.theme.getClass("widgetHeader") +
            '" style="display:none" />'),
          (o.rootBgContainerEl = i.querySelector(".fc-bg")),
          (o.slatContainerEl = i.querySelector(".fc-slats")),
          (o.bottomRuleEl = i.querySelector(".fc-divider")),
          (o.renderProps = n),
          o
        );
      }
      return (
        n(i, e),
        (i.prototype.processOptions = function () {
          var e,
            r,
            i = this.opt("slotDuration"),
            n = this.opt("snapDuration");
          (i = t.createDuration(i)),
            (n = n ? t.createDuration(n) : i),
            null === (e = t.wholeDivideDurations(i, n)) && ((n = i), (e = 1)),
            (this.slotDuration = i),
            (this.snapDuration = n),
            (this.snapsPerSlot = e),
            (r = this.opt("slotLabelFormat")),
            Array.isArray(r) && (r = r[r.length - 1]),
            (this.labelFormat = t.createFormatter(
              r || {
                hour: "numeric",
                minute: "2-digit",
                omitZeroMinute: !0,
            ...
            (this.labelInterval = r
              ? t.createDuration(r)
              : this.computeLabelInterval(i));
        }),
        (i.prototype.computeLabelInterval = function (e) {
          var r, i, n;
          for (r = u.length - 1; r >= 0; r--)
            if (
              ((i = t.createDuration(u[r])),
              null !== (n = t.wholeDivideDurations(i, e)) && n > 1)
            )
              return i;
          return e;
        }),
        ...
        (i.prototype._renderSlats = function (e) {
          ...
          (this.slatContainerEl.innerHTML =
            ...
            (this.slatPositions = new t.PositionCache(
              this.el,
              this.slatEls,
              !1,
              !0
        ...
        (i.prototype.renderSlatRowHtml = function (e) {
          for (
            var r,
              ...
              a = this.isRtl,
              l = "",
              d = t.startOfDay(e.renderRange.start),
              c = e.minTime,
              h = t.createDuration(0);
            t.asRoughMs(c) < t.asRoughMs(e.maxTime);

          )
            (r = o.add(d, c)),
              (i = null !== t.wholeDivideDurations(h, this.labelInterval)),
              (n =
                ...
                (i
                  ? "<span>" +
                    t.htmlEscape(o.format(r, this.labelFormat)) +
                    "</span>"
                  : "") +
                "</td>"),
              (l +=
                '<tr data-time="' +
                t.formatIsoTimeString(r) +
                '"' +
                (i ? "" : ' class="fc-minor"') +
                ">" +
                (a ? "" : n) +
                ...
                (a ? n : "") +
                "</tr>"),
              (c = t.addDurations(c, this.slotDuration)),
        ...
        (i.prototype._renderColumns = function (e, i) {
          ...
          (this.rootBgContainerEl.innerHTML =
            ...
            "</table>"),
            (this.colEls = t.findElements(
              this.el,
              ".fc-day, .fc-disabled-day"
            ));
          for (var l = 0; l < this.colCnt; l++)
            this.publiclyTrigger("dayRender", [
              { date: o.toDate(e[l].date), el: this.colEls[l], view: s },
            ]);
          this.isRtl && this.colEls.reverse(),
            (this.colPositions = new t.PositionCache(
              this.el,
              this.colEls,
              !0,
              !1
        ...
        (i.prototype.renderContentSkeleton = function () {
          ...
          this.isRtl && r.reverse(),
            ...
            (this.mirrorContainerEls = t.findElements(
              e,
              ".fc-mirror-container"
            )),
            (this.fgContainerEls = t.findElements(
              e,
              ".fc-event-container:not(.fc-mirror-container)"
            )),
            (this.bgContainerEls = t.findElements(e, ".fc-bgevent-container")),
            (this.highlightContainerEls = t.findElements(
              e,
              ".fc-highlight-container"
            )),
            (this.businessContainerEls = t.findElements(
              e,
        ...
        (i.prototype.renderNowIndicator = function (e, r) {
          if (this.colContainerEls) {
            ...
            for (i = 0; i < e.length; i++) {
              ...
              (s.style.top = n + "px"),
                this.colContainerEls[e[i].col].appendChild(s),
                o.push(s);
            }
            if (e.length > 0) {
        ...
        (i.prototype.unrenderNowIndicator = function () {
          this.nowIndicatorEls &&
            (this.nowIndicatorEls.forEach(t.removeElement),
        ...
        (i.prototype.computeDateTop = function (e, r) {
          return (
            r || (r = t.startOfDay(e)),
            this.computeTimeTop(t.createDuration(e.valueOf() - r.valueOf()))
          );
        }),
        (i.prototype.computeTimeTop = function (e) {
          var r,
            ...
            s =
              (e.milliseconds - t.asRoughMs(o.minTime)) /
              t.asRoughMs(this.slotDuration);
          return (
            (s = Math.max(0, s)),
            (s = Math.min(n, s)),
            (r = Math.floor(s)),
            (i = s - (r = Math.min(r, n - 1))),
            this.slatPositions.tops[r] + this.slatPositions.getHeight(r) * i
          );
        }),
        (i.prototype.computeSegVerticals = function (e) {
          var t,
            r,
            i,
            n = this.opt("timeGridEventMinHeight");
          for (t = 0; t < e.length; t++)
            (r = e[t]),
              (i = this.props.cells[r.col].date),
              (r.top = this.computeDateTop(r.start, i)),
              (r.bottom = Math.max(r.top + n, this.computeDateTop(r.end, i)));
        }),
        (i.prototype.assignSegVerticals = function (e) {
          var r, i;
          for (r = 0; r < e.length; r++)
            (i = e[r]), t.applyStyle(i.el, this.generateSegVerticalCss(i));
        }),
          ...
          if (null != a && null != l) {
            var d = o.tops[l],
              ...
              f = t.addDurations(
                ...
                t.multiplyDuration(this.snapDuration, u)
              ),
              g = i.add(p, f);
            return {
              col: a,
              dateSpan: {
                range: { start: g, end: i.add(g, this.snapDuration) },
                allDay: !1,
              },
              dayEl: this.colEls[a],
              relativeRect: {
    ...
    m = (function (e) {
      function i(i, n, o, s) {
        ...
        (a.splitter = new f()),
          (a.renderHeadIntroHtml = function () {
            ...
            return a.opt("weekNumbers")
              ? ((e = n.format(o.start, g)),
                '<th class="fc-axis fc-week-number ' +
                  i.getClass("widgetHeader") +
                  '" ' +
                  a.axisStyleAttr() +
                  ">" +
                  t.buildGotoAnchorHtml(
                    a,
                    { date: o.start, type: "week", forceOff: s > 1 },
                    t.htmlEscape(e)
                  ) +
                  "</th>")
              : '<th class="fc-axis ' +
          ...
          (a.renderTimeGridBgIntroHtml = function () {
            return (
              '<td class="fc-axis ' +
              a.theme.getClass("widgetContent") +
              '" ' +
              a.axisStyleAttr() +
              "></td>"
            );
        ...
        var l = a.scroller.el;
        a.el.querySelector(".fc-body > tr > td").appendChild(l),
          l.classList.add("fc-time-grid-container");
        var d = t.createElement("div", { className: "fc-time-grid" });
        if (
          (l.appendChild(d),
          (a.timeGrid = new p(a.context, d, {
            renderBgIntroHtml: a.renderTimeGridBgIntroHtml,
            renderIntroHtml: a.renderTimeGridIntroHtml,
          })),
          a.opt("allDaySlot"))
        ) {
          a.dayGrid = new r.DayGrid(
            a.context,
            a.el.querySelector(".fc-day-grid"),
            {
          ...
          var c = a.el.querySelector(".fc-divider");
          a.dayGrid.bottomCoordPadding = c.getBoundingClientRect().height;
        }
        return a;
      }
      return (
        ...
        (i.prototype.updateSize = function (t, r, i) {
          e.prototype.updateSize.call(this, t, r, i),
        ...
        (i.prototype.updateBaseSize = function (e, r, i) {
          var n,
            ...
            a = this;
          if (
            ((this.axisWidth = t.matchCellWidths(
              t.findElements(this.el, ".fc-axis")
            )),
            ...
            i ||
              ((o = this.computeScrollerHeight(r)), this.scroller.setHeight(o));
        }),
  ...
  var y = (function (e) {
    function r(r, i) {
      ...
      return (
        (n.buildDayRanges = t.memoize(v)),
        (n.slicer = new S()),
        (n.timeGrid = i),
        r.calendar.registerInteractiveComponent(n, { el: n.timeGrid.el }),
        n
      );
    }
    return (
      ...
      (r.prototype.render = function (e) {
        ...
        this.timeGrid.receiveProps(
          o({}, this.slicer.sliceProps(e, t, null, this.timeGrid, i), {
            dateProfile: t,
            cells: r.cells[0],
          })
        );
  ...
  var S = (function (e) {
    ...
    C = (function (e) {
      function i(i, n, o, s) {
        var a = e.call(this, i, n, o, s) || this;
        return (
          (a.buildDayTable = t.memoize(E)),
          a.opt("columnHeader") &&
            (a.header = new t.DayHeader(
              a.context,
              a.el.querySelector(".fc-head-container")
            )),
          (a.simpleTimeGrid = new y(a.context, a.timeGrid)),
          a.dayGrid &&
            (a.simpleDayGrid = new r.SimpleDayGrid(a.context, a.dayGrid)),
          a
        );
      }
      return (
        ...
        (i.prototype.render = function (t) {
          ...
          this.header &&
            ...
            this.simpleTimeGrid.receiveProps(
              o({}, n.timed, { dateProfile: r, dayTable: i })
            ),
            this.simpleDayGrid &&
