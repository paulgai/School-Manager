...
function Projectors_timetable_validateData() {
	...
	// check all required fields have values
	if(!AppGini.Validation.fieldRequired('lookup', 'teacher_id', '&#917;&#954;&#960;&#945;&#953;&#948;&#949;&#965;&#964;&#953;&#954;&#972;&#962;')) return false;
	if(!AppGini.Validation.fieldRequired('date', 'date', '&#919;&#956;&#941;&#961;&#945;')) return false;
	if(!AppGini.Validation.fieldRequired('lookup', 'hour_id', '&#911;&#961;&#945;')) return false;
...
function persist_expanded_child(id) {
	var expand_these = JSON.parse(localStorage.getItem('Assignments.dvp_expand'));
	...
	if($j('[id=' + id + ']').hasClass('active')) {
		if(expand_these.indexOf(id) < 0) {
			...
			localStorage.setItem('Assignments.dvp_expand', JSON.stringify(expand_these));
		}
	} else {
		if(expand_these.indexOf(id) >= 0) {
