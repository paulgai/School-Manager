...
!(function (e, t) {
  ...
  function I(e) {
    return e.getBoundingClientRect().height + C(e);
  }
  function C(e) {
  ...
  function ge(e, t) {
    ...
    return (
      e.start && ((n = B(e.start)), r && r <= n && (r = x(n, 1))),
      { start: n, end: r }
    );
  }
  function ye(e, t, n, r) {
    return "year" === r
      ? J(n.diffWholeYears(e, t), "year")
      : "month" === r
      ? J(n.diffWholeMonths(e, t), "month")
      : z(e, t);
  }
  var me = function (e, t) {
    return (me =
  ...
  function _e(e, t, n) {
    ...
    i)) {
      ...
      if (s.recurringDef) {
        ...
        for (
          var l = 0,
            c = be(s, u, t, n.dateEnv, n.pluginSystem.hooks.recurringTypes);
          l < c.length;
          l++
        ) {
          var d = c[l],
  ...
  function Le(e, t) {
    var n,
      ...
      i = [],
      o = t.start;
    for (e.sort(Be), n = 0; n < e.length; n++)
  ...
  var Ge = {
    ...
    tt = (function () {
      function e(e) {
        ...
        for (var i in e)
          i in Ge
            ? ((n[i] = e[i]), (r = Math.max(Ge[i], r)))
            : ((t[i] = e[i]), i in Xe && (r = Math.max(Xe[i], r)));
  ...
  function ot(e, t) {
    return "object" == typeof e && e
      ? ("string" == typeof t && (e = Se({ separator: t }, e)), new tt(e))
      : "string" == typeof e
      ? new rt(e, t)
      : "function" == typeof e
      ? new it(e)
      ...
      return (
        (e.prototype.setProp = function (e, t) {
          ...
          if (e in Vt);
            ...
            var i = void 0;
            "function" == typeof xt[e] && (t = xt[e](t)),
              "color" === e
                ? (i = { backgroundColor: t, borderColor: t })
                : "editable" === e
                ? (i = { startEditable: t, durationEditable: t })
                : (((r = {})[e] = t), (i = r)),
        ...
        (e.prototype.setDates = function (e, t, n) {
          ...
          if (a && (null == t || (r = i.createMarker(t))) && this._instance) {
            ...
            if (r) {
              ...
              $(u, l)
                ? this.mutate({ datesDelta: u, standardProps: o })
                : this.mutate({ startDelta: u, endDelta: l, standardProps: o });
            } else
        ...
        Object.defineProperty(e.prototype, "source", {
          get: function () {
            ...
            return e
              ? new lt(this._calendar, this._calendar.state.eventSources[e])
              : null;
          },
          enumerable: !0,
          configurable: !0,
  ...
  function dt(e, t, n, r) {
    var i = {},
      ...
      l = vt(e.defs, t);
    for (var c in e.defs) {
      "inverse-background" === (S = e.defs[c]).rendering &&
        (S.groupId
          ? ((i[S.groupId] = []), a[S.groupId] || (a[S.groupId] = S))
          : (o[c] = []));
    }
    for (var d in e.instances) {
      var f = e.instances[d],
        ...
        g = Ve(v, n);
      g &&
        ("inverse-background" === S.rendering
          ? S.groupId
            ? i[S.groupId].push(g)
            : o[f.defId].push(g)
          : ("background" === S.rendering ? s : u).push({
              def: S,
              ui: p,
              instance: f,
              range: g,
    ...
    e.hasPublicHandlers("eventRender") &&
      (t = t.filter(function (t) {
        var r = e.publiclyTrigger("eventRender", [
          {
            event: new ct(e.calendar, t.eventRange.def, t.eventRange.instance),
            isMirror: n,
            isStart: t.isStart,
            isEnd: t.isEnd,
            el: t.el,
  ...
  function Et(e, t, n, r, i) {
    ...
    return (
      ...
      t.allDay && (u.range = { start: B(u.range.start), end: B(u.range.end) }),
        ...
        !(function (e, t, n, r) {
          ...
          for (var p in s) {
            ...
            for (var E in ("function" != typeof m && (m = null), d)) {
              var S = d[E];
              if (Fe(v, S.range)) {
                var b = f[S.defId].overlap;
                if (!1 === b && i.isEvent) return !1;
                if (!1 === g.overlap) return !1;
                if (m && !m(new ct(t, c[S.defId], S), new ct(t, y, h)))
                  return !1;
              }
            }
            for (
              var D = t.state.eventStore, T = 0, w = g.allows;
              T < w.length;
              T++
            ) {
              var R = w[T],
                ...
                k = void 0;
              if (
                ((k = C ? new ct(t, C, M) : new ct(t, y)),
                !R(t.buildDateSpanApi(I), k))
              )
                return !1;
            }
          }
  ...
  function It(e, t, n, r, i) {
    for (var o = 0, a = e; o < a.length; o++) {
      if (!kt(Ct(a[o], t, n, r, i), t)) return !1;
    }
    return !0;
  }
  ...
  function Ht(e, t, n) {
    ...
    return {
      ...
      durationEditable:
        null != r.durationEditable ? r.durationEditable : r.editable,
  ...
  function Ft(e, t, n, r) {
    ...
    if (a)
      return (
        ((s = Wt(o, t, a.allDay, Boolean(a.duration), n)).recurringDef = {
          typeId: a.typeId,
          typeData: a.typeData,
          duration: a.duration,
        }),
      ...
      l = (function (e, t, n, r, i) {
        var o,
          ...
          s = (function (e, t) {
            var n = he(e, Vt, {}, t);
            return (
              (n.start = null !== n.start ? n.start : n.date), delete n.date, n
            );
          })(e, r),
          u = s.allDay,
          l = null,
    ...
    return l
      ? {
          def: (s = Wt(u, t, l.allDay, l.hasEnd, n)),
          instance: Zt(s.defId, l.range, l.forcedStartTzo, l.forcedEndTzo),
        }
      : null;
  }
  function Wt(e, t, n, r, i) {
    ...
    return (
      (a.extendedProps = Se(o, a.extendedProps || {})),
  ...
  function qt(e, t, n) {
    ...
    function s() {
      (i && je(i, arguments)) ||
        (a(), (r = this), (i = arguments), e.apply(this, arguments));
    }
      ...
      return (
        (e.prototype.splitProps = function (e) {
          ...
          for (var c in ((this.eventUiBuilders = Re(n, function (e, n) {
            return t.eventUiBuilders[n] || Ye(Jt);
          })),
          n)) {
            var d = n[c],
              f = a[c] || Gt,
  ...
  function Kt(e, t, n, r) {
    ...
    return (
      t instanceof Date
        ? (i = t)
        : ((i = t.date), (o = t.type), (a = t.forceOff)),
      (s = { date: u.formatIso(i, { omitTime: !0 }), type: o || "day" }),
      ...
      (r = r || ""),
      !a && e.opt("navLinks")
        ? "<a" + n + ' data-goto="' + Ot(JSON.stringify(s)) + '">' + r + "</a>"
        : "<span" + n + ">" + r + "</span>"
    );
  }
  function Qt(e, t, n, r) {
    ...
    return (
      Ze(t.activeRange, e)
        ? (c.push("fc-" + P[e.getUTCDay()]),
          s.opt("monthMode") &&
            l.getMonth(e) !== l.getMonth(t.currentRange.start) &&
          ...
          e < i
            ...
            : e >= o
            ? c.push("fc-future")
            : (c.push("fc-today"), !0 !== r && c.push(u.getClass("today"))))
    ...
    tn = (function (e) {
      ...
      return (
        ...
        (t.prototype.on = function (e, t) {
          return nn(this._handlers || (this._handlers = {}), e, t), this;
        }),
        (t.prototype.one = function (e, t) {
          return nn(this._oneHandlers || (this._oneHandlers = {}), e, t), this;
        }),
        (t.prototype.off = function (e, t) {
          return (
            this._handlers && rn(this._handlers, e, t),
            this._oneHandlers && rn(this._oneHandlers, e, t),
            this
          );
        }),
        ...
        (t.prototype.triggerWith = function (e, t, n) {
          return (
            this._handlers && de(this._handlers[e], t, n),
            this._oneHandlers &&
              (de(this._oneHandlers[e], t, n), delete this._oneHandlers[e]),
            this
          );
        }),
      ...
      return (
        ...
        (t.prototype.lockOverflow = function (e) {
          ...
          (e = e || this.getScrollbarWidths()),
            "auto" === t &&
              (t =
                e.bottom || this.canScrollHorizontally() ? "scroll" : "hidden"),
            "auto" === n &&
              (n =
                e.left || e.right || this.canScrollVertically()
                  ? "scroll"
                  : "hidden"),
            y(this.el, { overflowX: t, overflowY: n });
        }),
  ...
  (cn.prototype.classes = {}),
    (cn.prototype.iconClasses = {}),
    (cn.prototype.baseIconClass = ""),
    (cn.prototype.iconOverridePrefix = "");
  var dn = 0,
    fn = (function () {
      function e(e, t) {
        t && (e.view = this),
  ...
  var pn = (function (e) {
    ...
    return (
      ...
      (t.prototype.isDateSelectionValid = function (e) {
        ...
        return (
          !(r && !We(r.validRange, e.range)) &&
          ((t = e), (n = this.calendar), wt({ dateSelection: t }, n))
        );
      }),
        ...
        if (this.hasPublicHandlers("eventPositioned"))
          for (var r = 0, i = e; r < i.length; r++) {
            ...
            this.publiclyTriggerAfterSizing("eventPositioned", [
              {
                event: new ct(n, o.eventRange.def, o.eventRange.instance),
                isMirror: t,
                isStart: o.isStart,
                isEnd: o.isEnd,
                el: o.el,
  ...
  (pn.prototype.fgSegSelector = ".fc-event-container > *"),
    (pn.prototype.bgSegSelector = ".fc-bgevent:not(.fc-nonbusiness)");
  var hn = 0;
  function vn(e) {
    return {
      id: String(hn++),
          ...
          var r = e.eventSource.meta,
            i = (function (e, t, n) {
              ...
              Se(u, a),
                ...
                (u[i] = s.formatIso(t.end)),
                "local" !== s.timeZone && (u[o] = s.timeZone);
              return u;
    ...
    recurringTypes: [
      {
        parse: function (e, t, n) {
          ...
          if (s) {
            var l = null;
            return (
              "duration" in t && ((l = J(t.duration)), delete t.duration),
              !l &&
                a.startTime &&
                a.endTime &&
                ((r = a.endTime),
  ...
  function wn(e, t, n) {
    for (
      var r = Ce(t.state.eventSources), i = [], o = 0, a = e;
      o < a.length;
      o++
    ) {
            ...
            r =
              (function (e, t) {
                for (var n = 0; n < e.length; n++)
                  for (
                    var r = e[n].toLocaleLowerCase().split("-"), i = r.length;
                    i > 0;
                    i--
                  ) {
      ...
      return (
        ...
        (e.prototype.compute = function () {
          var e = fe(
            ...
            i =
              "rtl" === fe(this.dynamicOverrides.dir, this.overrides.dir, r.dir)
                ? In
                : {};
          (this.dirDefaults = i),
            (this.localeDefaults = r),
            (this.computed = Te(
              [Rn, i, r, this.overrides, this.dynamicOverrides],
              Cn
            ));
        }),
        e
  ...
  var Bn = (function () {
      ...
      return (
        ...
        (e.prototype.diffWholeMonths = function (e, t) {
          var n = this.calendarSystem;
          return q(e) === q(t) && n.getMarkerDay(e) === n.getMarkerDay(t)
            ? n.getMarkerMonth(t) -
                n.getMarkerMonth(e) +
        ...
        (e.prototype.offsetForMarker = function (e) {
          return "local" === this.timeZone
            ? -W(Z(e)).getTimezoneOffset()
            : "UTC" === this.timeZone
            ? 0
            : this.namedTimeZoneImpl
            ? this.namedTimeZoneImpl.offsetForArray(Z(e))
            : null;
        }),
        (e.prototype.toDate = function (e, t) {
          return "local" === this.timeZone
            ...
            ? new Date(
                e.valueOf() -
                  1e3 * this.namedTimeZoneImpl.offsetForArray(Z(e)) * 60
              )
  ...
  function Wn(e, t) {
    for (
      var n = t.pluginSystem.hooks.eventSourceDefs, r = n.length - 1;
      r >= 0;
      r--
    ) {
      var i = n[r].parseMeta(e);
      if (i) {
        var o = Zn("object" == typeof e ? e : {}, i, r, t);
        return (o._raw = e), o;
      }
    }
    return null;
        ...
        return (function (e, t, n, r) {
          ...
          if (o && n === o.latestFetchId)
            return Se(
              {},
              e,
              (((i = {})[t] = Se({}, o, { isFetching: !1, fetchRange: r })), i)
            );
          return e;
  ...
  var Jn = (function () {
    ...
    return (
      ...
      (e.prototype.build = function (e, t, n) {
        ...
        return (
          ...
          n &&
            ((d = e),
            (e =
              null != (f = r).start && d < f.start
                ? f.start
                : null != f.end && d >= f.end
                ? new Date(f.end.valueOf() - 1)
                : d)),
          (a = this.buildCurrentRangeInfo(e, t)),
          (s = /^(year|month|week|day)$/.test(a.unit)),
          (u = this.buildRenderRange(this.trimHiddenDays(a.range), a.unit, s)),
          (l = u = this.trimHiddenDays(u)),
          this.options.showNonCurrentDates || (l = Ve(l, a.range)),
          (i = J(this.options.minTime)),
          (o = J(this.options.maxTime)),
          (l = Ve((l = this.adjustActiveRange(l, i, o)), r)),
          (c = Fe(a.range, r)),
          {
            validRange: r,
      ...
      (e.prototype.buildCurrentRangeInfo = function (e, t) {
        ...
        return (
          r.duration
            ? ((o = r.duration),
              (a = r.durationUnit),
              (s = this.buildRangeFromDuration(e, t, o, a)))
            : (n = this.options.dayCount)
            ? ((a = "day"), (s = this.buildRangeFromDayCount(e, t, n)))
            : (s = this.buildCustomVisibleRange(e))
            ? (a = i.greatestWholeUnit(s.start, s.end).unit)
            : ((a = ne((o = this.getFallbackDuration())).unit),
              (s = this.buildRangeFromDuration(e, t, o, a))),
      ...
      (e.prototype.adjustActiveRange = function (e, t, n) {
        ...
        return (
          this.viewSpec.class.prototype.usesMinMaxTime &&
            (ee(t) < 0 && ((i = B(i)), (i = r.add(i, t))),
            ee(n) > 1 && ((o = x((o = B(o)), -1)), (o = r.add(o, n)))),
          { start: i, end: o }
        );
      }),
        ...
        return (
          c ||
            ((i = this.options.dateIncrement)
              ? ((o = J(i)), (c = te(o) < te(n) ? ne(o, !Q(i)).unit : r))
              : (c = r)),
          ee(n) <= 1 &&
            this.isHiddenDay(a) &&
            (a = B((a = this.skipHiddenDays(a, t)))),
          d(),
      ...
      (e.prototype.getRangeOption = function (e) {
        ...
        return (
          "function" == typeof r && (r = r.apply(null, t)),
          r && (r = Ue(r, this.dateEnv)),
          r && (r = ge(r)),
          r
        );
      }),
  ...
  function Kn(e, t, n) {
    for (
      var r = (function (e, t) {
        ...
        i = (function (e, t, n, r, i) {
          ...
          switch (t.type) {
            ...
            case "NEXT":
              ...
              break;
            case "SET_DATE":
              (e.activeRange && Ze(e.currentRange, t.dateMarker)) ||
          ...
          return !o ||
            ...
            (e &&
              ((s = e),
              (u = o),
              Ae(s.validRange, u.validRange) &&
                Ae(s.activeRange, u.activeRange) &&
                Ae(s.renderRange, u.renderRange) &&
                $(s.minTime, u.minTime) &&
                $(s.maxTime, u.maxTime)))
            ? e
            : o;
        ...
        o = jn(e.eventSources, t, i, n),
        a = Se({}, e, {
          viewType: r,
          dateProfile: i,
          currentDate: Qn(e.currentDate, t, i),
          eventSources: o,
          eventStore: St(e.eventStore, t, o, i, n),
          dateSelection: $n(e.dateSelection, t, n),
          eventSelection: er(e.eventSelection, t),
          eventDrag: tr(e.eventDrag, t, o, n),
          eventResize: nr(e.eventResize, t, o, n),
          eventSourceLoadingLevel: rr(o),
          loadingLevel: rr(o),
        }),
        s = 0,
        u = n.pluginSystem.hooks.reducers;
      s < u.length;
      s++
    ) {
      a = (0, u[s])(a, t, n);
  ...
  function Qn(e, t, n) {
    switch (t.type) {
      ...
      case "SET_VIEW_TYPE":
        ...
        return n.activeRange && !Ze(n.activeRange, r)
  ...
  function ar(e, t, n) {
    var r = Wt({ editable: !1 }, "", e.allDay, !0, n);
    return {
      def: r,
      ui: gt(r, t),
      instance: Zt(r.defId, e.range),
      range: e.range,
      isStart: !0,
      isEnd: !0,
    };
  ...
  function fr(e, t) {
    ...
    return Re(
      (function (e, t) {
        var n,
          r = {};
        for (n in e) sr(n, r, e, t);
        for (n in t) sr(n, r, e, t);
        return r;
      })(n, r),
      function (e) {
        return (function (e, t, n) {
          ...
          if (r && (i = J(r))) {
            var u = ne(i, !Q(r));
            (o = u.unit),
              1 === u.value && ((a = o), (s = t[o] ? t[o].options : {}));
          }
          var l = function (t) {
            var n = t.buttonText || {},
          ...
          return {
            ...
            buttonTextOverride:
              l(n.dynamicOverrides) || l(n.overrides) || e.overrides.buttonText,
            buttonTextDefault:
              l(n.localeDefaults) ||
              l(n.dirDefaults) ||
  ...
  var pr = (function (e) {
      function t(t, n) {
        ...
        return (
          (i._renderLayout = qt(i.renderLayout, i.unrenderLayout)),
          (i._updateTitle = qt(i.updateTitle, null, [i._renderLayout])),
          (i._updateActiveButton = qt(i.updateActiveButton, null, [
            i._renderLayout,
          ])),
          (i._updateToday = qt(i.updateToday, null, [i._renderLayout])),
          (i._updatePrev = qt(i.updatePrev, null, [i._renderLayout])),
          (i._updateNext = qt(i.updateNext, null, [i._renderLayout])),
          (i.el = r("div", { className: "fc-toolbar " + n })),
          i
        );
      }
      return (
        ...
        (t.prototype.renderLayout = function (e) {
          ...
          (this.viewsWithButtons = []),
            s(t, this.renderSection("left", e.left)),
            s(t, this.renderSection("center", e.center)),
            s(t, this.renderSection("right", e.right));
        }),
                    ...
                    "title" === e
                      ...
                      : ((r = d[e])
                          ? ((c = function (e) {
                            ...
                            (v = o.getCustomButtonIconClass(r)) ||
                              (v = o.getIconClass(e)) ||
                              (g = r.text))
                          : (s = l[e])
                          ? (n.viewsWithButtons.push(e),
                            ...
                            (g = s.buttonTextOverride) ||
                              (v = o.getIconClass(e)) ||
                              (g = s.buttonTextDefault))
                          : a[e] &&
                            ((c = function () {
                              a[e]();
                            }),
                            (g = f[e]) ||
                              ...
                              (g = p[e])),
                        c &&
                          ((m = ["fc-" + e + "-button", o.getClass("button")]),
                          g
                            ? ((y = Ot(g)), (S = ""))
                            : v &&
                              ((y = "<span class='" + v + "'></span>"),
    ...
    hr = (function (e) {
      function t(t, n) {
        var i = e.call(this, t) || this;
        (i._renderToolbars = qt(i.renderToolbars)),
          (i.buildViewPropTransformers = Ye(gr)),
          (i.el = n),
          u(n, (i.contentEl = r("div", { className: "fc-view-container" })));
        for (
          var o = i.calendar,
            a = 0,
            s = o.pluginSystem.hooks.viewContainerModifiers;
          a < s.length;
          a++
        ) {
          (0, s[a])(i.contentEl, o);
        ...
        return (
          ...
          (i.computeTitle = Ye(vr)),
          (i.parseBusinessHours = Ye(function (e) {
            return Yt(e, i.calendar);
          })),
          i
        );
      }
      return (
        ...
        (t.prototype.renderToolbars = function (e, t, n, r, i) {
          var o = this.opt("header"),
            ...
            p = {
              title: i,
              activeButton: e.type,
              isTodayEnabled: c.isValid && !Ze(t.currentRange, l),
              isPrevEnabled: d.isValid,
              isNextEnabled: f.isValid,
            };
          o
            ? (this.header ||
                ((this.header = new pr(this.context, "fc-header-toolbar")),
                u(this.el, this.header.el)),
              this.header.receiveProps(Se({ layout: o }, p)))
            : this.header && (this.header.destroy(), (this.header = null)),
            a
              ? (this.footer ||
                  ((this.footer = new pr(this.context, "fc-footer-toolbar")),
                  s(this.el, this.footer.el)),
                this.footer.receiveProps(Se({ layout: a }, p)))
        ...
        (t.prototype.renderView = function (e, t) {
          ...
          for (
            var o = {
              ...
              a = 0,
              s = this.buildViewPropTransformers(
        ...
        (t.prototype.computeHeightVars = function () {
          ...
          if (
            ...
            this.viewHeight =
              r.getBoundingClientRect().height - this.queryToolbarsHeight();
          } else
        ...
        (t.prototype.queryToolbarsHeight = function () {
          var e = 0;
          return (
            this.header && (e += I(this.header.el)),
            this.footer && (e += I(this.footer.el)),
            e
          );
        }),
      ...
      function t(t) {
        ...
        return (
          (n.destroy = O(
            r.el,
            "click",
            r.fgSegSelector + "," + r.bgSegSelector,
            n.handleSegClick
          )),
          n
        );
      ...
      function t(t) {
        ...
        return (
          (n.removeHoverListeners =
            ((r = u.el),
            (i = u.fgSegSelector + "," + u.bgSegSelector),
            (o = n.handleSegEnter),
            (a = n.handleSegLeave),
            O(r, "mouseover", i, function (e, t) {
              if (t !== s) {
                (s = t), o(e, t);
                var n = function (e) {
          ...
          u.calendar.on("eventElRemove", n.handleEventElRemove),
          n
        );
      }
      return (
  ...
  var Dr = (function () {
    function e(e, t) {
      var n = this;
      (this.parseRawLocales = Ye(On)),
        (this.buildLocale = Ye(_n)),
        (this.buildDateEnv = Ye(Tr)),
        (this.buildTheme = Ye(wr)),
        (this.buildEventUiSingleBase = Ye(this._buildEventUiSingleBase)),
        (this.buildSelectionConfig = Ye(this._buildSelectionConfig)),
        (this.buildEventUiBySource = qe(Ir, Me)),
        (this.buildEventUiBases = Ye(Cr)),
        ...
        (this.buildDelayedRerender = Ye(Rr)),
        (this.afterSizingTriggers = {}),
        (this.isViewUpdated = !1),
        (this.isDatesUpdated = !1),
        (this.isEventsUpdated = !1),
        (this.el = e),
        (this.optionsManager = new xn(t || {})),
        (this.pluginSystem = new gn()),
    ...
    return (
      ...
      (e.prototype.bindHandlers = function () {
        ...
        (this.removeNavLinkListener = O(
          ...
          function (t, n) {
            ...
            "function" == typeof s
              ? s(i.toDate(o), t)
              : ("string" == typeof s && (a = s), e.zoomTo(o, a));
          }
        )),
        ...
        if ((this.actionQueue.push(e), !this.isReducing)) {
          ...
          (t.eventStore !== n.eventStore || this.needsFullRerender) &&
            ...
            (t.dateProfile !== n.dateProfile || this.needsFullRerender) &&
              (t.dateProfile &&
                r &&
                this.publiclyTrigger("datesDestroy", [{ view: r, el: r.el }]),
      ...
      (e.prototype.renderComponent = function (e) {
        ...
        var a = (this.renderableEventStore =
            t.eventSourceLoadingLevel && !this.opt("progressiveEventRendering")
        ...
        (!e && n) ||
          ...
          o && n.view.applyScroll(o, !1),
          this.isViewUpdated &&
            ((this.isViewUpdated = !1),
            this.publiclyTrigger("viewSkeletonRender", [
              { view: n.view, el: n.view.el },
            ])),
          this.isDatesUpdated &&
            ((this.isDatesUpdated = !1),
      ...
      (e.prototype.mutateOptions = function (e, t, n, r) {
        ...
        for (var p in a)
          /^(height|contentHeight|aspectRatio)$/.test(p)
            ? (c = !0)
            : /^(defaultDate|defaultView)$/.test(p) ||
              ((d = !0), "timeZone" === p && (l = !0));
        this.optionsManager.mutate(a, t, n),
          d &&
            (this.handleOptions(this.optionsManager.computed),
          ...
          this.batchRendering(function () {
            if (
              (d
                ? (l && i.dispatch({ type: "CHANGE_TIMEZONE", oldDateEnv: u }),
                  i.dispatch({
                    type: "SET_VIEW_TYPE",
      ...
      (e.prototype.handleOptions = function (e) {
        ...
        (this.defaultAllDayEventDuration = J(e.defaultAllDayEventDuration)),
          (this.defaultTimedEventDuration = J(e.defaultTimedEventDuration)),
        ...
        (this.dateEnv = this.buildDateEnv(
          ...
          (this.viewSpecs = fr(n.views, this.optionsManager)),
          (this.dateProfileGenerators = Re(this.viewSpecs, function (e) {
      ...
      (e.prototype.changeView = function (e, t) {
        ...
        t &&
          ...
          this.unselect(),
          this.dispatch({ type: "SET_VIEW_TYPE", viewType: e, dateMarker: n });
      }),
      ...
      (e.prototype.addEvent = function (e, t) {
        if (e instanceof ct) {
          ...
          return (
            this.state.eventStore.defs[n.defId] ||
              this.dispatch({
                type: "ADD_EVENTS",
                eventStore: Oe({ def: n, instance: r }),
              }),
            e
          );
        }
        ...
        return a
          ? (this.dispatch({ type: "ADD_EVENTS", eventStore: Oe(a) }),
            new ct(this, a.def, a.def.recurringDef ? null : a.instance))
          : null;
      }),
  ...
  function wr(e) {
    return new (this.pluginSystem.hooks.themeClasses[e.themeSystem] || br)(e);
  }
  function Rr(e) {
  ...
  var Mr = (function (e) {
    function t(t, n, i, o) {
      var a =
        e.call(
          this,
          t,
          r("div", { className: "fc-view fc-" + n.type + "-view" }),
          !0
        ) || this;
      return (
        (a.renderDatesMem = qt(a.renderDatesWrap, a.unrenderDatesWrap)),
        (a.renderBusinessHoursMem = qt(
          a.renderBusinessHours,
          a.unrenderBusinessHours,
          [a.renderDatesMem]
        )),
        (a.renderDateSelectionMem = qt(
          a.renderDateSelectionWrap,
          a.unrenderDateSelectionWrap,
          [a.renderDatesMem]
        )),
        (a.renderEventsMem = qt(a.renderEvents, a.unrenderEvents, [
          a.renderDatesMem,
        ])),
        (a.renderEventSelectionMem = qt(
          a.renderEventSelectionWrap,
          a.unrenderEventSelectionWrap,
          [a.renderEventsMem]
        )),
        (a.renderEventDragMem = qt(
          a.renderEventDragWrap,
          a.unrenderEventDragWrap,
          [a.renderDatesMem]
        )),
        (a.renderEventResizeMem = qt(
          a.renderEventResizeWrap,
          a.unrenderEventResizeWrap,
          [a.renderDatesMem]
        )),
        (a.viewSpec = n),
        (a.dateProfileGenerator = i),
        (a.type = n.type),
        (a.eventOrderSpecs = ie(a.opt("eventOrder"))),
        (a.nextDayThreshold = J(a.opt("nextDayThreshold"))),
        o.appendChild(a.el),
        a.initialize(),
        a
      );
    ...
    return (
      ...
      (t.prototype.renderDatesWrap = function (e) {
        this.renderDates(e),
          this.addScroll({ duration: J(this.opt("scrollTime")) }),
      ...
      (t.prototype.computeEventDraggable = function (e, t) {
        for (
          var n = this.calendar.pluginSystem.hooks.isDraggableTransformers,
            r = t.startEditable,
            i = 0,
            o = n;
          i < o.length;
      ...
      (t.prototype.startNowIndicator = function (e) {
        ...
        this.opt("nowIndicator") &&
          ...
          (r =
            o.add(o.startOf(this.initialNowDate, t), J(1, t)).valueOf() -
  ...
  tn.mixInto(Mr),
    (Mr.prototype.usesMinMaxTime = !1),
    (Mr.prototype.dateProfileGeneratorClass = Jn);
  var kr = (function () {
    function e(e) {
      ...
      (e.prototype._getTimeText = function (e, t, n, r, i, o, a) {
        ...
        return (
          ...
          this.displayEventTime && !n
            ? i && t
              ? s.formatRange(e, t, r, { forcedStartTzo: o, forcedEndTzo: a })
  ...
  var _r = (function () {
      ...
      return (
        ...
        (e.prototype.unrender = function (e) {
          ...
          t &&
            ("bgEvent" === e && this.context.view.triggerWillRemoveSegs(t, !1),
            this.detachSegs(e, t));
        }),
        (e.prototype.renderSegEls = function (e, t) {
          var n,
          ...
          if (t.length) {
            ...
            o(i).forEach(function (e, n) {
              ...
              "bgEvent" === e && (t = ft(this.context.view, t, !1)),
  ...
  function Hr(e) {
    var t = _n(e.locale || "en", On([]).map);
    return (
      (e = Se({ timeZone: Rn.timeZone, calendarSystem: "gregory" }, e, {
        locale: t,
      })),
      new Bn(e)
    );
  ...
  function Lr(e, t, n, r, i, o, a, s) {
    ...
    return (
      (u =
        "function" == typeof f.columnHeaderHtml
          ? f.columnHeaderHtml(c.toDate(e))
          : "function" == typeof f.columnHeaderText
          ? Ot(f.columnHeaderText(c.toDate(e)))
          : Ot(c.format(e, i))),
      n ? (h = h.concat(Qt(e, t, o, !0))) : h.push("fc-" + P[e.getUTCDay()]),
      '<th class="' +
        h.join(" ") +
        '"' +
        (p && n
          ? ' data-date="' + c.formatIso(e, { omitTime: !0 }) + '"'
          : "") +
        (a > 1 ? ' colspan="' + a + '"' : "") +
        (s ? " " + s : "") +
        ">" +
        (p ? Kt(l, { date: e, forceOff: !n || 1 === r }, u) : u) +
        "</th>"
    );
  }
  var Br = (function (e) {
      ...
      return (
        ...
        (t.prototype.render = function (e) {
          ...
          for (
            var i = ot(this.opt("columnHeaderFormat") || Ur(n, t.length)),
              o = 0,
              a = t;
            o < a.length;
            o++
    ...
    Vr = (function () {
      function e(e, t) {
        for (var n = e.start, r = e.end, i = [], o = [], a = -1; n < r; )
          t.isHiddenDay(n) ? i.push(a + 0.5) : (a++, i.push(a), o.push(n)),
            (n = x(n, 1));
      ...
      return (
        ...
        (e.prototype.sliceNowDate = function (e, t) {
          ...
          return this._sliceDateSpan.apply(
            this,
            [{ range: { start: e, end: H(e, 1) }, allDay: !1 }, {}, t].concat(n)
          );
        }),
        (e.prototype._sliceBusinessHours = function (e, t, n, r) {
          ...
          return e
            ? this._sliceEventStore.apply(
                this,
                [_e(e, Wr(t, Boolean(n)), r.calendar), {}, t, n, r].concat(i)
              ).bg
            : [];
        }),
        ...
        (e.prototype._sliceInteraction = function (e, t, n, r, i) {
          for (var o = [], a = 5; a < arguments.length; a++)
            o[a - 5] = arguments[a];
          if (!e) return null;
          var s = dt(e.mutatedEvents, t, Wr(n, Boolean(r)), r);
          return {
        ...
        (e.prototype._sliceDateSpan = function (e, t, n) {
          ...
          if (!e) return [];
          for (
            var o = ar(e, t, n.calendar),
              a = this.sliceRange.apply(this, [e.range].concat(r)),
              s = 0,
              u = a;
            s < u.length;
            s++
  ...
  (e.Calendar = Dr),
    ...
    (e.DateComponent = pn),
    (e.DateEnv = Bn),
    (e.DateProfileGenerator = Jn),
    (e.DayHeader = Br),
    (e.DaySeries = Vr),
    (e.DayTable = Ar),
    (e.ElementDragging = xr),
    (e.ElementScrollController = sn),
    (e.EmitterMixin = tn),
    (e.EventApi = ct),
    (e.FgEventRenderer = kr),
    (e.FillRenderer = _r),
    (e.Interaction = yr),
    (e.Mixin = en),
    (e.NamedTimeZoneImpl = Pr),
    (e.PositionCache = on),
    (e.ScrollComponent = ln),
    (e.ScrollController = an),
    (e.Slicer = Fr),
    (e.Splitter = Xt),
    (e.Theme = cn),
    (e.View = Mr),
    ...
    (e.allowSelection = function (e) {
      e.classList.remove("fc-unselectable"),
        e.removeEventListener("selectstart", k);
    }),
    (e.appendToElement = s),
    (e.applyAll = de),
    (e.applyMutationToEventStore = yt),
    (e.applyStyle = y),
    (e.applyStyleProp = m),
    ...
    (e.buildGotoAnchorHtml = Kt),
    (e.buildSegCompareObj = Or),
    (e.capitaliseFirstLetter = ue),
    (e.combineEventUis = Ut),
    (e.compareByFieldSpec = ae),
    (e.compareByFieldSpecs = oe),
    (e.compareNumbers = function (e, t) {
      return e - t;
    }),
    (e.compensateScroll = function (e, t) {
      t.left && y(e, { borderLeftWidth: 1, marginLeft: t.left - 1 }),
        t.right && y(e, { borderRightWidth: 1, marginRight: t.right - 1 });
    }),
    ...
    (e.computeEdges = T),
    (e.computeFallbackHeaderFormat = Ur),
    (e.computeHeightAndMargins = I),
    (e.computeInnerRect = w),
    (e.computeRect = R),
    (e.computeVisibleDayRange = ge),
    (e.config = {}),
    ...
    (e.formatRange = function (e, t, n) {
      ...
      return o && a
        ? r.formatRange(o.marker, a.marker, i, {
    ...
    (e.getAllDayHtml = function (e) {
      return e.opt("allDayHtml") || Ot(e.opt("allDayText"));
    }),
    ...
    (e.processScopedUiProps = Nt),
    (e.rangeContainsMarker = Ze),
    (e.rangeContainsRange = We),
    (e.rangesEqual = Ae),
