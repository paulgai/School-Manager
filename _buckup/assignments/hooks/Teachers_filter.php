...
<?php } else { ?>
	...
	<button class="btn btn-lg btn-default pull-right search_mode" type="submit" name="Filter_x" value="1">Switch to advanced search mode</button>
			...
			<div class="page-header"><h1>
				<a href="Teachers_view.php" style="text-decoration: none; color: inherit;">
					<img src="resources/table_icons/group.png"> 					Εκπαιδευτικοί Filters</a>
			</h1></div>
	...
	<div class="row vspacer-lg" style="border-bottom: dotted 2px #DDD;">
		...
		<div class="hidden-xs hidden-sm col-md-3 vspacer-lg text-right"><label for="">Τομέας</label></div>
		<div class="hidden-md hidden-lg col-xs-12 vspacer-lg"><label for="">Τομέας</label></div>
	...
	<div class="row" style="border-bottom: dotted 2px #DDD;">
		...
		<div class="hidden-xs hidden-sm col-md-3 vspacer-lg text-right"><label for="">Τοποθέτηση</label></div>
		<div class="hidden-md hidden-lg col-xs-12 vspacer-lg"><label for="">Τοποθέτηση</label></div>
		
		
		<input type="hidden" class="optionsData" name="FilterField[2]" value="5">
		<div class="col-xs-10 col-sm-11 col-md-8 col-lg-6">
			...
			<input type="hidden" name="FilterValue[2]" id="5_currValue" value="<?php echo htmlspecialchars($FilterValue[2]); ?>" size="3">

	
			<div class="radio">
				<label>
					 <input type="radio" name="FilterValue[2]" class="filter_5" value='ΟΡΓΑΝΙΚΗ'>ΟΡΓΑΝΙΚΗ				</label>
			</div>
	 
			<div class="radio">
				<label>
					 <input type="radio" name="FilterValue[2]" class="filter_5" value='ΑΝΑΠΛΗΡΩΤΗΣ'>ΑΝΑΠΛΗΡΩΤΗΣ				</label>
			</div>
	 
			<div class="radio">
				<label>
					 <input type="radio" name="FilterValue[2]" class="filter_5" value='ΑΠΟΣΠΑΣΗ'>ΑΠΟΣΠΑΣΗ				</label>
			</div>
	 
			<div class="radio">
				<label>
					 <input type="radio" name="FilterValue[2]" class="filter_5" value='ΔΙΑΘΕΣΗ'>ΔΙΑΘΕΣΗ				</label>
			</div>
	 		</div>
	...
	<script>
		//for population
		var filterValue_5 = '<?php echo htmlspecialchars($FilterValue[ 2 ]); ?>';
		$j(function () {
			if (filterValue_5) {
				$j("input[class =filter_5][value ='" + filterValue_5 + "']").prop("checked", true);
			}
		})
	</script>
